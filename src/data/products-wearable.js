export const WEARABLE_PRODUCTS = {
  'mystery-graphic-t': {
    id: 'mystery-graphic-t',
    name: 'The Mystery Graphic T',
    subtitle: '100% Cotton',
    category: 'Apparel',
    price: 85,
    ...
    story: 'Four designs born from moments caught between dream and reality. The airship navigating unknown coordinates. Mountains burning gold in fading light. Trees standing honest and untamed. Each graphic holds a secret, printed on cotton that moves with you.',
    materials: ['100% Premium Cotton', 'Mid-Weight', 'Soft Hand Feel', 'High-Quality Print'],
    sizes: ['Mens S', 'Mens M', 'Mens L', 'Mens XL', 'Womens S', 'Womens M', 'Womens L'],
    care: 'Machine wash cold. Tumble dry low. Iron inside out if needed.',
    inStock: true,
    featured: true,
    hasVariants: true,
    variantType: 'design',
  ...
  'mystery-dyed-t': {
    id: 'mystery-dyed-t',
    name: 'The Mystery Dyed T',
    subtitle: '100% Cotton',
    category: 'Apparel',
    price: 85,
    featuredImage: '/images/products/t-shirts/spiral-tie-dye.png',
    color: '#8B5CF6',
  ...
  'lost-burro-luxe-tee': {
    id: 'lost-burro-luxe-tee',
    name: 'The Lost Burro · Mystery Luxe T',
    subtitle: '100% Merino Wool',
    category: 'Apparel',
    price: 125,
    stripePriceId: 'price_TEMP_LOST_BURRO_LUXE',
    ...
    story: 'There are stories of a burro who wandered far into the mountains and never came back. Some say he still roams beneath starlight carrying fragments of an energy too bright to name. This piece is cut from mid-heavy weight merino wool, holding to you with quiet strength. What glows unseen often matters most.',
    materials: ['100% Merino Wool', 'Mid-Heavy Weight', 'Premium Construction', 'Temperature Regulating'],
    sizes: ['Mens S', 'Mens M', 'Mens L', 'Mens XL', 'Womens S', 'Womens M', 'Womens L'],
    care: 'Hand wash in cold water. Lay flat to dry. Do not wring. Merino naturally resists odor.',
    inStock: true,
    limited: true
  },
  ...
  'burro-socks': {
    ...
    story: 'Sometimes the smallest things carry the most comfort. These crew socks are pure merino wool, breathable and temperature-regulating. They do not slip. They do not bunch. They just work, quietly making every step a little better.',
    materials: ['100% Merino Wool', 'Crew Length', 'Temperature Regulating', 'Naturally Antimicrobial'],
    sizes: ['Unisex S', 'Unisex M', 'Unisex L'],
    care: 'Machine wash cold. Tumble dry low. Merino stays fresh longer than cotton.',
    inStock: true,
    hasVariants: true,
    variantType: 'design',
    designs: [
