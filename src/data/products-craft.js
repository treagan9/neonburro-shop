...
export const CRAFT_PRODUCTS = {
  'nibble-wands': {
    ...
    featuredImage: '/images/products/nibble-wands/nibble-wands-case.webp',
    color: '#C5D957',
  ...
  'halfway-nook': {
    ...
    featuredImage: '/images/products/halfway-nook/halfway-nook-titanium.webp',
    color: '#C0C0C0',
    ...
    designs: [
      {
        id: 'titanium',
        name: 'Titanium',
        image: '/images/products/halfway-nook/halfway-nook-titanium.webp',
        description: 'Three ounces, no flavour, no rust. You will lose it before you break it.',
      },
      {
        id: 'copper',
        name: 'Copper',
        image: '/images/products/halfway-nook/halfway-nook-copper.webp',
