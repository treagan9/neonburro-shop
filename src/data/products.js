export const products = {
  ...
  'mystery-t': {
    id: 'mystery-t',
    name: 'The Mystery T Collection',
    subtitle: '100% Cotton',
    price: 85,
    stripePriceId: 'price_1SEc9lGWJVsbrWy8WeWz8pPe',
    description: 'Stories woven into fabric. Each design carries its own energy, waiting to reveal itself.',
    longDescription: 'Every pattern holds a secret. Some speak of seasons that never end, others of journeys through color and light. These are not just shirts—they are wearable mysteries, crafted from premium 100% cotton that breathes and moves with you. Each design emerged from a moment caught between thought and dream, between what was and what could be. Choose the design that speaks to your current journey.',
    images: ['/images/products/t-shirts/mystery-t-shirt-main.png'],
    featuredImage: '/images/products/t-shirts/mystery-t-shirt-main.png',
    color: '#8B5CF6',
    category: 'Apparel',
    materials: ['100% Premium Cotton', 'Mid-Weight', 'Soft Hand Feel'],
    sizes: ['Mens S', 'Mens M', 'Mens L', 'Mens XL', 'Womens S', 'Womens M', 'Womens L'],
    designs: [
      {
        id: 'autumn-mountain',
